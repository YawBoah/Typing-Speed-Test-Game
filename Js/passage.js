const paragraphs =[
    ...
    "Aside from his club success, Ronaldo has been a key figure for the Portuguese national team. He has represented Portugal in multiple European Championships and FIFA World Cups, leading them to victory in Euro 2016 and the UEFA Nations League in 2019.",
    
    "Known for his incredible work ethic, athleticism, and dedication to the game, Cristiano Ronaldo remains one of the greatest footballers of all time. His famous number 7 jersey is iconic in the world of football.",

    "Off the pitch, CR7 is also a successful businessman and philanthropist. He has his own fashion line, fragrance brand, and has contributed to various charitable causes.",

    "In summary, Cristiano Ronaldo, or CR7, is more than just a footballer. He is a global icon, a record-breaker, and an inspiration to aspiring athletes worldwide.",

    "Lionel Messi, often regarded as the greatest footballer of all time, is a true legend of the sport. His incredible skills on the field have earned him numerous accolades and records.",

    "Messi's dribbling ability is second to none. He can glide past defenders with ease, leaving them in his wake. His close ball control is simply mesmerizing to watch.",

    "Scoring goals seems to come naturally to Messi. He holds the record for the most goals scored in a calendar year, a testament to his scoring prowess.",

    "But it's not just his goals that make Messi special. His vision and passing ability are exceptional. He can pick out a teammate with pinpoint accuracy, often providing assists that lead to crucial goals.",
    ...
    "Zinedine Zidane, the legendary footballer, is often regarded as one of the greatest midfielders in the history of the sport. His skill on the ball and vision on the field were second to none. Many fans remember him for his elegant playing style and his ability to create magic on the pitch.",

    "In modern football, Zidane's name is synonymous with success. He achieved numerous accolades as both a player and a manager. His time as the head coach of Real Madrid saw the team dominate European football, winning three consecutive UEFA Champions League titles.",
